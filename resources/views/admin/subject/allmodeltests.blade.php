          ...
          <div class="card-header">
            <div class="row">
              ...
              <div class="col-md-2 align-right btn btn-primary">
                <a href="{{url('/admin/add/model')}}" style="color: #fff;">Add Modeltest</a>
              </div>
            </div>
          </div>
          <div class="card-body">
                ...
                <table class="table table-bordered dataTable"  width="100%">
                    ...
                    <tbody>
                      @foreach($model as $data)
                        <tr>
                            <td>{{str_limit($data->name,70)}}</td>
                            <td>{{$data->created_at}}</td>
                            <td>
                              <a href="{{url('/admin/add_questions/'.$data->id)}}" class="btn btn-info" title="add"><i class="fas fa-clipboard-list"></i></a>
                               <a href="{{url('/admin/view/modeltest/'.$data->id)}}" class="btn btn-success" title="view"></a>
