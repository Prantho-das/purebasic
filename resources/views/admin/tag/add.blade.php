...
<div class="content mt-3">
    <div class="animated fadeIn">
          ...
          <div class="card-body card-block">
            <form action="{{url('/admin/tag/submit')}}" method="post" enctype="multipart/form-data">
              @csrf
                  <div class="form-group"><label for="nf-email" class=" form-control-label">Tag Name</label>
                    <input type="taxt" id="nf-email" name="name" placeholder="Enter tag name.." class="form-control">
                  </div>
