            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{url('admin/questions/'.$model->id)}}" class="btn btn-primary"><i
                                    class="fas fa-book"></i> All Questions</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{url('/admin/add/questions/'.$model->id)}}" method="post"
                          enctype="multipart/form-data">
                        @csrf
                        <input type="text" hidden value="{{ $model->exam_type }}">
