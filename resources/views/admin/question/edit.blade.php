      ...
      <div class="container-fluid">
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
              <div class="col-md-10">
                <a href="{{url('/admin/all/job')}}"></a><i class="fas fa-plus"></i> 
                Questions Uploads
              </div>
              <div class="col-md-2">
                 <a href="{{url('admin/questions/'.$data->modeltest_id)}}" class="btn btn-primary"><i class="fas fa-book"></i> All Questions</a>
              </div>
            </div>
          </div>

          <div class="card-body">
            <form action="{{url('/admin/edit/questions/'.$id)}}" method="post" enctype="multipart/form-data">
             @csrf
