                ...
                <div class="col-4 marginAbove round lecture">
                    ...
                    @if(!empty($data->video || $data->youtube_video_id))
                        ...
                        <div class="videoButtonContainer">
                            ...
                            <a href="/student/{{Session::get('id')}}/watch/clinical_case/{{$data->id}}" class="videoButton" onclick="watchHistory({{json_encode($dataInfo)}})">&#x25B6</a>
                            <p style="margin: 0; text-align: center">{{'Price : ' . $data->price . ' Taka'}}</p>
