        ...
        @foreach($info as $key=>$data)
            ...
            <div class="row lectureContainer marginBelow">
                ...
                <div class="col-4 marginAbove round lecture">
                    ...
                    <p>
                        <a href="/free_lectures/batch/{{$batch_id . '/'}}" class="tag">{{$data->category}}</a>&nbsp
                        ...
                        @endphp
                        <a href="/free_lectures/batch/{{$batch_id . '/' . 'subject/' . $subject_id . '/chapter'}}" class="tag">{{$chapterName}}</a>
                    ...
                    @if(!empty($data->video || $data->youtube_video_id))
                        ...
                        <div class="videoButtonContainer">
                            ...
                            <a href="{{'/free_lectures/batch/' . $batch_id . '/class/' . $data->id}}" class="videoButton" onclick="watchHistory({{json_encode($dataInfo)}})">&#x25B6</a>
                        </div>
                    @endif
