...
@section('content')
            ...
            <div class="batchDetailsInfo">
                ...
                @isset($batchpackage->promotion_video)
                    <div class="plyr__video-embed" id="player">
                        ...
                        <div id="overlay"
                            style="position: absolute; top: 0; left: 0; height: 100%; width: 100%; background-color: black; z-index: 2;">
                            &nbsp</div>

                        <iframe width="560" height="315" src="{{ $batchpackage->promotion_video }}" frameborder="0"
    ...
    @endforeach
            ...
            <div class="row">
                ...
                @endif
                @if (!$enrolled)
                    <a class="col-12 centerText batchInfoButton"
                        href="{{ $batchpackage->module == 1 ? url('/batch/' . $batchpackage->batch_id . '/modules') : url('/student/batch/' . $batchpackage->batch_id . '/enroll') }}">Enroll
                        Now</a>
                @endif
            </div>
