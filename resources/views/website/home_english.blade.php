...
@section('content')
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="branch-parent-box">
                        <div class="singlecard-parent">
                            <a href="#">
                                <div class="image-box">
                                    <img src="{{ asset('assets/images/home/l1.jpeg') }}" alt="skill">
                                </div>
                        ...
                        <div class="singlecard-parent">
                            <a href="#">
                                <div class="image-box">
                                    <img src="{{ asset('assets/images/home/l2.jpeg') }}" alt="skill">
                        ...
                        <div class="singlecard-parent">
                            <a href="#">
                                <div class="image-box">
                                    <img src="{{ asset('assets/images/home/l3.jpeg') }}" alt="skill">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="course-design-thumb">
                        <img src="{{ asset('assets/images/home/offer-video.png') }}" alt="offer-video.png">
    ...
    <section class="offline-branch-main">
        ...
        <div class="team-shape2">
            <img src="{{ asset('assets/images/icons/54.png') }}" alt="shape2">
        </div>
    </section>
