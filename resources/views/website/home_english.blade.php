                                        ...
                                        <div class="single-course">
                                            <a href="#">
                                                <div class="inner-wrapper">
                                                    <div class="icon">
                                                        <img src="{{ asset('assets/images/home/s.jpeg') }}" alt="skill">
                                                    </div>
                                ...
                                <div class="banner-parent-box bg-1">
                                    ...
                                    <div class="skill-grid-parent">
                                        <div class="single-skill">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/home/c1.jpeg') }}" alt="skill">
                                            </a>
                                        </div>
                                        <div class="single-skill">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/home/c2.jpeg') }}" alt="skill">

                                            </a>
                                        </div>
                                        <div class="single-skill">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/home/c3.jpg') }}" alt="skill">

                                            </a>
                                        </div>
                                        <div class="single-skill">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/home/c4.jpg') }}" alt="skill">

                                            </a>
                                        </div>
                                        <div class="single-skill">
                                            <a href="#">
                                                <img src="{{ asset('assets/images/home/c5.jpg') }}" alt="skill">
                ...
                <div class="testimonial-slider-wrapper">
                    <div class="swiper testimonial-slider">
                        <div class="swiper-wrapper">
                            ...
                            {{-- [{"problem_id": "6", "review_data": {"id": 6, "name": "Estiuk Ahammed Bhuiyan",
                            "photo": "lc_imageHhtIUfKyp0oqNJB1.jpg", "review": "# বিপ্লব ভাই: আমার দেখা সবচেয়ে ডেডিকেটেড
                            টিচার।। কোন ননমেডিকেল ও যদি উনার ক্লাস করে তবে ওরাও মেডিকেলের বইকে ক্লাস ওয়ানের অ আ ক খ মনে
                            করবে।। এত সহজ এবং প্রানবন্ত পড়াশুনা\r\n\r\n# কো অরডিনেটরস: ভাইয়ারা এত এত সহজ ভাবে মোটিভেট
                            করেন যে,\r\n \"হতাশা\" উনাদের চেহারা দেখলেই পালাবে\r\n\r\n# পিউর বেসিকের একটা বিশাল অংশ জুড়ে
                            থাকবে অফিস সহকারীরা।। অনেক বেশী হেল্পফুল।।\r\n\r\nইনশাল্লাহ একদিন দেশের অনেক ডেন্টাল কলেজের
                            বিভাগীয় প্রধানরা নতুনদের পিওরবেসিকের গল্প দিয়ে মেডিকেলের ক্লাস শুরু করাবে।।।", "status": 1,
                            "created_at": "2020-07-18 02:38:08", "updated_at": null}}, {"problem_id": "9",
                            "review_data": {"id": 9, "name": "Jasmin Akther", "photo": "lc_imageoWyEF0LiAXfSW4A6.jpg",
                            "review": "Pure basic is all about basic study;inspiration;hardworking and
                            success...teaching process of dr.sarwer.biplob is outstanding... Everyone in pure basic
                            family are so friendly and helpful. Many many blessings for pure basic group...", "status":
                            1, "created_at": "2020-07-18 02:49:13", "updated_at": null}}, {"problem_id": "11",
                            "review_data": {"id": 11, "name": "Mashrufa Akhter Disha", "photo":
                            "lc_imagezKL5sMrTWycf2ngI.jpg", "review": "Owner of Pure Basic,Sarwar Biplob vya is an
                            ingenious and dedicated person,possesses excellent teaching ability which makes him
                            different from others.Best wishes for our mentor and pure basic team.", "status": 1,
                            "created_at": "2020-07-18 02:52:29", "updated_at": null}}] --}}
...
$firstCategory=$data->batch_category_data;
                            ...
                            @endphp
                            <div class="swiper-slide" onclick="fetchCategoryCourse({{ $data->batch_category_data->id }})">
                                <div class="single-skill-tab {{ $first ? 'active' : '' }} single-skill-tab-{{ $data->batch_category_data->id }}">
                                    <div class="name">{{ $data->batch_category_data->name }}</div>
                                    <div class="course-count">{{ $data->batch_category_data->total_course ??0 }} Courses</div> {{-- Assuming $data has courses;
                                    adjust if needed --}}
                                </div>
                            </div>
...
<script>
    // code fwhere a seconde word of a linek get a extra color active color
        ...
        $.get("{{ route('web.search') }}", { batch_category: batch_category })
        .done(function(data) {
