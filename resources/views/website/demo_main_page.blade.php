...
@section('content')
    ...
    <h3 class="centerText">PURE BASIC</h3>
        ...
        <div class="col-6 cardContainer cardContainer1">
            ...
            <a class="card" href="/batch/2/free_lecture">
            ...
            <a href="/notices" class="card" id="notice">
                ...
                <span style="{{$new > 0 ? 'color: red' : 'color: #03136f'}}"><b>Notice</b></span><span class="{{$new > 0 ? 'noticeBadge' : ''}}">{{$new > 0 ? $new : ''}}</span>
            </a>
    ...
    <div class="centerText">
        <h3>
            <a href="https://www.facebook.com/pure.basic/">Facebook | </a>
            <a href="https://www.youtube.com/channel/UCWhKeITJoIt5B-izmkv4B0g">Youtube</a>
        </h3>
    </div>
    ...
    <div id="loginModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <form>
            <label><b>Please Login to Proceed</b></label>
