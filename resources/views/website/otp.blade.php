            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel"
                        ...
                        <form method="post" action="{{url('student/otp/verify/'.$student->id.'/'.$is_login)}}"></form>
                        ...
                        <button type="button" class="btn btn-primary common-btn-design" id="otp-submit-btn">Submit OTP
