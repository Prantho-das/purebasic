...
@section('content')
    ...
    <div class="row" style="margin-top:3rem;">
        ...
        <div class="col-6 cardContainer cardContainer1">
            ...
            <div class="card" onclick="onEnrollClicked()">
            ...
            <a href="https://api.whatsapp.com/send?phone=%2B8801874626253" class="card">
            ...
            <a href="/notices" class="card" id="notice">
                ...
                <span style="{{$new > 0 ? 'color: red' : 'color: #03136f'}}"><b>নোটিশ</b></span><span class="{{$new > 0 ? 'noticeBadge' : ''}}">{{$new > 0 ? $new : ''}}</span>
            </a>
    ...
    <div id="facultyModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <form>
            ...
            <label for="Medicine"><b>মেডিসিন</b></label><br>
            <input type="radio" id="Dentistry" name="faculty" value="2">
            <label for="Dentistry"><b>ডেন্টিস্ট্রি</b></label><br>
            <input type="radio" id="BCS" name="faculty" value="3">
            <label for="BCS"><b>বিসিএস</b></label>
            
            <div style="margin-top: 1rem; width: 20%;"><a id="goButton" class="goButton">সাবমিট</a></div>
    ...
    <div id="loginModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <form>
            <label><b>অনুগ্রহ করে লগইন করুন</b></label>
            
            <div style="margin-top: 1rem; width: 20%;"><a id="loginButton" class="loginButton" href="/student/login">লগইন</a></div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener("click", (event) => {
            ...
            if(checkedRadioInput) {
                goButton.href="/batches/category/" + checkedRadioInput.value;
