            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="<?php echo e(url('admin/questions/'.$model->id)); ?>" class="btn btn-primary"><i
                                    class="fas fa-book"></i> All Questions</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form action="<?php echo e(url('/admin/add/questions/'.$model->id)); ?>" method="post"
                          enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="text" hidden value="<?php echo e($model->exam_type); ?>">
