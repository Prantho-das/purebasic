        ...
        <?php $__currentLoopData = $info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row lectureContainer marginBelow">
                ...
                <div class="col-4 marginAbove round lecture">
                    ...
                    <p>
                        <a href="/free_lectures/batch/<?php echo e($batch_id . '/'); ?>" class="tag"><?php echo e($data->category); ?></a>&nbsp
                        ...
                        ?>
                        <a href="/free_lectures/batch/<?php echo e($batch_id . '/' . 'subject/' . $subject_id . '/chapter'); ?>" class="tag"><?php echo e($chapterName); ?></a>
                    ...
                    <?php if(!empty($data->video || $data->youtube_video_id)): ?>
                        ...
                        <div class="videoButtonContainer">
                            ...
                            <a href="<?php echo e('/free_lectures/batch/' . $batch_id . '/class/' . $data->id); ?>" class="videoButton" onclick="watchHistory(<?php echo e(json_encode($dataInfo)); ?>)">&#x25B6</a>
                        </div>
                    <?php endif; ?>
