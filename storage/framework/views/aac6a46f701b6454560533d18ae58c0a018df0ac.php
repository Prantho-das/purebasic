...
<div class="container-fluid">
   <div class="card mb-3">
      <div class="card-header">
         <div class="row">
            <div class="col-md-10">
               <a href="<?php echo e(url('/admin/lecture-sheet')); ?>"></a></i>
               Lecture-Sheet</a>
            </div>
         </div>
      </div>
      <div class="card-body">
         <form action="<?php echo e(url('/admin/upload/lecture-sheet')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <select class="form-control" name="batch[]" multiple="">
                        ...
                        <option value="<?php echo e($data->id); ?>" <?php echo e($data->id == 49 ? 'selected' : ''); ?>><?php echo e($data->plan); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
                  </div>
               </div>
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="video_id" class="form-control" value="<?php echo e($lastSerial + 1); ?>">
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="form-group">
                     ...
                     <input type="text" name="dateTime" class="form-control" value="<?php echo e(old('dateTime')); ?>"
