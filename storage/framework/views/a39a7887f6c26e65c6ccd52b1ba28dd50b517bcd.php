      ...
      <div class="container-fluid">
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
              <div class="col-md-10">
                <a href="<?php echo e(url('/admin/all/job')); ?>"></a><i class="fas fa-plus"></i> 
                Questions Uploads
              </div>
              <div class="col-md-2">
                 <a href="<?php echo e(url('admin/questions/'.$data->modeltest_id)); ?>" class="btn btn-primary"><i class="fas fa-book"></i> All Questions</a>
              </div>
            </div>
          </div>

          <div class="card-body">
            <form action="<?php echo e(url('/admin/edit/questions/'.$id)); ?>" method="post" enctype="multipart/form-data">
             <?php echo csrf_field(); ?>
            ...
            <div class="row">
              <?php
                $que_options = App\Option::where('question_id',$data->id)->get();
                $alphabet = ['A','B','C','D','E'];
              ?>
