                ...
                <div class="row chapterContainer" id="<?php echo e($startsFrom != 'null' ? $serial : $key + 1); ?>">
                    ...
                    <div class="col-4 marginAbove round chapter">
                        ...
                        <div class="centerText">
                            ...
                            <p>Subject : </span><a href="/free_lectures/batch/<?php echo e($batch_id . '/'); ?>"><?php echo e($subject_info->name); ?></a></p>
                            
                            <p><a href="<?php echo e('/free_lectures/batch/' . $batch_id . '/subject/' . $subject_id . '/chapter/' . $chapter->id . '/classes'); ?>" class="linkButton"><?php echo e($chapterName); ?></a></p>
