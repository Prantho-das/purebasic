    ...
    <div class="profileContainer">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <button class="centerText examLink linkCategory" style="color:white; margin: 0.5rem; border: 0rem;" onclick="onClicked()" >Take Free Exams</button>
                ...
                <?php $__currentLoopData = $enrolledBatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="enrolledProgram">
                        ...
                        <div style="padding-top: 2rem; padding-bottom: 2rem;">
                            ...
                            <a class="centerText examLink linkCategory" href="<?php echo e(url('exam_by_batch',$batch->batch_id)); ?>">Go To Exam</a>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener("click", (event) => {
            ...
            if(checkedRadioInput) {
                goButton.href="/free_exam/batch/" + checkedRadioInput.value;
