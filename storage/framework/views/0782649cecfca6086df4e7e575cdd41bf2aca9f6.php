                  ...
                  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">Close Index</a>
                    ...
                    ?>
                              ...
                              <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <button class="dropdown-btn"><?php echo e($subject->name); ?> 
                                    ...
                                    <div class="dropdown-container"> 
                                        ...
                                        <?php $__currentLoopData = $chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          ...
                                          <button class="dropdown-btn"><?php echo e($chapter->name); ?> 
                                            <i class="fa fa-caret-down"></i>
                                          </button>
                                            ...
                                            <?php $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <a href="/question_bank_topic/<?php echo e($topic->id); ?>"><?php echo e($topic->name); ?></a>
